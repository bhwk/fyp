...
async def main(k):
    ...
    results = await load_and_process_questions(k)

    output_file = f"semantic_k{k}_{int(time.time())}.json"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Run RAG semantic accuracy with a specified k value."
    )
    parser.add_argument(
