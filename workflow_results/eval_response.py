...
def main(reference_file):
    ...
    bleu_score, rouge_score = compute_bleu_rouge(references, predictions)
    bert_score_result = compute_bert_score(references, predictions)
    sem_score = compute_sem_score(references, predictions)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Compute BLEU, ROUGE, BERTScore, and SemScore between responses."
    )
    parser.add_argument(
        "reference_file",
        type=str,
